    ...
    with open(csv_path, 'r', newline='') as file:
        ...
        for row in reader:
            try:
                ...
                name = row.get('Nombre') or row.get('Name') or row.get('name') or row.get('nombre')
                phone = row.get('Telefono') or row.get('Phone') or row.get('phone') or row.get('telefono')
        ...
        click.echo(f"Import complete. {success_count} players added, {failure_count} failures.")
